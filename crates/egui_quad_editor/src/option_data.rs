...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(feature = "serde", serde(default))]
pub struct QuadEditorOptions {
    /// Whether to show the ASCII representation of all the `u8` values in the main UI.
    pub show_ascii: bool,
    /// Whether `0x00` values in the main UI should use the [`QuadEditorOptions::zero_colour`].
...
impl Default for QuadEditorOptions {
    fn default() -> Self {
        QuadEditorOptions {
            ...
            quad_editor_text_style: TextStyle::Monospace,
            quad_editor_address_text_style: TextStyle::Monospace,
            quad_editor_ascii_text_style: TextStyle::Monospace,
