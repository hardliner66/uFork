...
pub const DEBUG_DEV: Any = Any {
    raw: OPQ_RAW | MUT_RAW | 2,
};
pub const CLOCK_DEV: Any = Any {
    raw: OPQ_RAW | MUT_RAW | 3,
};
pub const IO_DEV: Any = Any {
    raw: OPQ_RAW | MUT_RAW | 4,
};
pub const BLOB_DEV: Any = Any {
    raw: OPQ_RAW | MUT_RAW | 5,
};
pub const TIMER_DEV: Any = Any {
    raw: OPQ_RAW | MUT_RAW | 6,
};
pub const MEMO_DEV: Any = Any {
    raw: OPQ_RAW | MUT_RAW | 7,
};
pub const HOST_DEV: Any = Any {
    raw: OPQ_RAW | MUT_RAW | 8,
};
pub const RANDOM_DEV: Any = Any {
    raw: OPQ_RAW | MUT_RAW | 9,
};
...
impl Core {
    pub fn new(
        ...
        let mut quad_rom = [Quad::empty_t(); QUAD_ROM_MAX];
         ...
         */
        let mut quad_ram = [Quad::empty_t(); QUAD_RAM_MAX];
        ...
        quad_ram[SPONSOR.ofs()] =
            Quad::sponsor_t(Any::fix(4096), Any::fix(256), Any::fix(8192), UNDEF); // root configuration sponsor
    ...
    */
    ...
    fn e_first(&self) -> Any {
        self.ram(self.ddeque()).t()
    }
    fn set_e_first(&mut self, ptr: Any) {
        self.ram_mut(self.ddeque()).set_t(ptr);
    }
    fn e_last(&self) -> Any {
        self.ram(self.ddeque()).x()
    }
    fn set_e_last(&mut self, ptr: Any) {
        self.ram_mut(self.ddeque()).set_x(ptr);
    }
    fn k_first(&self) -> Any {
        self.ram(self.ddeque()).y()
    }
    fn set_k_first(&mut self, ptr: Any) {
        self.ram_mut(self.ddeque()).set_y(ptr);
    }
    fn k_last(&self) -> Any {
        self.ram(self.ddeque()).z()
    }
    fn set_k_last(&mut self, ptr: Any) {
        self.ram_mut(self.ddeque()).set_z(ptr);
    }
    pub fn ddeque(&self) -> Any {
        DDEQUE
    }

    pub fn rom_top(&self) -> Any {
        self.rom_top
    }
    pub fn set_rom_top(&mut self, ptr: Any) {
        assert!(ptr.is_rom());
        self.rom_top = ptr
    }
    pub fn ram_top(&self) -> Any {
        self.ram(self.memory()).t()
    }
    fn set_ram_top(&mut self, ptr: Any) {
        self.ram_mut(self.memory()).set_t(ptr);
    }
    fn ram_next(&self) -> Any {
        self.ram(self.memory()).x()
    }
    fn set_ram_next(&mut self, ptr: Any) {
        self.ram_mut(self.memory()).set_x(ptr);
    }
    fn ram_free(&self) -> Any {
        self.ram(self.memory()).y()
    }
    fn set_ram_free(&mut self, fix: Any) {
        self.ram_mut(self.memory()).set_y(fix);
    }
    fn ram_root(&self) -> Any {
        self.ram(self.memory()).z()
    }
    fn set_ram_root(&mut self, ptr: Any) {
        self.ram_mut(self.memory()).set_z(ptr);
    }
    pub fn memory(&self) -> Any {
        MEMORY
    }
    ...
    fn gc_load(&self, ptr: Any) -> Quad {
        // load quad directly
        let raw = ptr.raw();
        if (raw & (DIR_RAW | MUT_RAW)) != MUT_RAW {
            // must be ram or cap
    ...
    fn gc_store(&mut self, ptr: Any, quad: Quad) {
        // store quad directly
        let raw = ptr.raw();
        if (raw & (DIR_RAW | MUT_RAW)) != MUT_RAW {
            // must be ram or cap
    ...
    fn quad(&self, ptr: Any) -> &Quad {
        // non-forwarding quad access
        if ptr.is_fix() {
...
mod tests {
    ...
    fn load_std(core: &mut Core) -> Any {
        ...
        pub const SINK_BEH: Any = Any {
            raw: (STD_OFS + 0) as Raw,
        }; // alias for no-op behavior
        pub const COMMIT: Any = Any {
            raw: (STD_OFS + 0) as Raw,
        };
        quad_rom[COMMIT.ofs()] = Quad::vm_end_commit();
        pub const SEND_MSG: Any = Any {
            raw: (STD_OFS + 1) as Raw,
        };
        quad_rom[SEND_MSG.ofs()] = Quad::vm_send(MINUS_1, COMMIT);
        pub const CUST_SEND: Any = Any {
            raw: (STD_OFS + 2) as Raw,
        };
        quad_rom[CUST_SEND.ofs()] = Quad::vm_msg(PLUS_1, SEND_MSG);
        pub const RV_SELF: Any = Any {
            raw: (STD_OFS + 3) as Raw,
        };
        quad_rom[RV_SELF.ofs()] = Quad::vm_my_self(CUST_SEND);
        pub const RV_UNDEF: Any = Any {
            raw: (STD_OFS + 4) as Raw,
        };
        quad_rom[RV_UNDEF.ofs()] = Quad::vm_push(UNDEF, CUST_SEND);
        pub const RV_NIL: Any = Any {
            raw: (STD_OFS + 5) as Raw,
        };
        quad_rom[RV_NIL.ofs()] = Quad::vm_push(NIL, CUST_SEND);
        pub const RV_FALSE: Any = Any {
            raw: (STD_OFS + 6) as Raw,
        };
        quad_rom[RV_FALSE.ofs()] = Quad::vm_push(FALSE, CUST_SEND);
        pub const RV_TRUE: Any = Any {
            raw: (STD_OFS + 7) as Raw,
        };
        quad_rom[RV_TRUE.ofs()] = Quad::vm_push(TRUE, CUST_SEND);
        pub const RV_UNIT: Any = Any {
            raw: (STD_OFS + 8) as Raw,
        };
        quad_rom[RV_UNIT.ofs()] = Quad::vm_push(UNIT, CUST_SEND);
        pub const RV_ZERO: Any = Any {
            raw: (STD_OFS + 9) as Raw,
        };
        quad_rom[RV_ZERO.ofs()] = Quad::vm_push(ZERO, CUST_SEND);
        pub const RV_ONE: Any = Any {
            raw: (STD_OFS + 10) as Raw,
        };
        quad_rom[RV_ONE.ofs()] = Quad::vm_push(PLUS_1, CUST_SEND);
        pub const RESEND: Any = Any {
            raw: (STD_OFS + 11) as Raw,
        };
        quad_rom[RESEND.ofs() + 0] = Quad::vm_msg(ZERO, Any::rom(RESEND.ofs() + 1));
        quad_rom[RESEND.ofs() + 1] = Quad::vm_my_self(SEND_MSG);
        pub const STOP: Any = Any {
            raw: (STD_OFS + 13) as Raw,
        };
        quad_rom[STOP.ofs()] = Quad::vm_end_stop();
        pub const ABORT: Any = Any {
            raw: (STD_OFS + 14) as Raw,
        };
    ...
    */
    fn load_fib_test(core: &mut Core) -> Any {
        ...
        pub const COMMIT: Any = Any {
            raw: (LIB_OFS + 0) as Raw,
        };
        quad_rom[COMMIT.ofs()] = Quad::vm_end_commit();
        pub const SEND_MSG: Any = Any {
            raw: (LIB_OFS + 1) as Raw,
        };
        quad_rom[SEND_MSG.ofs()] = Quad::vm_send(MINUS_1, COMMIT);
        pub const CUST_SEND: Any = Any {
            raw: (LIB_OFS + 2) as Raw,
        };
        quad_rom[CUST_SEND.ofs()] = Quad::vm_msg(PLUS_1, SEND_MSG);

        pub const F_FIB_OFS: usize = LIB_OFS + 3;
        pub const F_FIB_BEH: Any = Any {
            raw: F_FIB_OFS as Raw,
        };
        ...
        pub const F_FIB_K: Any = Any {
            raw: (F_FIB_OFS + 22) as Raw,
        };
        // state: cust
        ...
        pub const F_FIB_K2: Any = Any {
            raw: (F_FIB_OFS + 26) as Raw,
        };
        // state: (cust m)
        ...
        pub const EQ_8_BEH: Any = Any {
            raw: (TEST_OFS + 6) as Raw,
        };
    ...
    fn load_dict_test(core: &mut Core) -> Any {
        ...
        pub const T_DICT_BEH: Any = Any {
            raw: T_DICT_OFS as Raw,
        };
    ...
    fn load_deque_test(core: &mut Core) -> Any {
        ...
        pub const T_DEQUE_BEH: Any = Any {
            raw: T_DEQUE_OFS as Raw,
        };
    ...
    fn load_device_test(core: &mut Core) -> Any {
        ...
        pub const T_DEV_BEH: Any = Any {
            raw: T_DEV_OFS as Raw,
        };
        ...
        pub const BLOB_IO_BEH: Any = Any {
            raw: BLOB_IO_OFS as Raw,
        };
        // () <- blob
        ...
        pub const COUNT_TO: Any = Any {
            raw: COUNT_TO_OFS as Raw,
        };
        // (m) <- (n)
